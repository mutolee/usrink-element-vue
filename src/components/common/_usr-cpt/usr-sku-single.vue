...
<template>
    <div class="usr_cpt_panel_add_sku">
        <el-row class="tit">
            <el-col :span="8">
...
<style scoped>
.usr_cpt_panel_add_sku .el-row:not(.tit) {
    margin-bottom: 10px;
}

.usr_cpt_panel_add_sku .el-row.tit .el-text {
    color: #73767a;
}

.usr_cpt_panel_add_sku .el-col {
    padding-right: 10px;
}

.usr_cpt_panel_add_sku .el-input-number {
    width: 100%;
}
</style>